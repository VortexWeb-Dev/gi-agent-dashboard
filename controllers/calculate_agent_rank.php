...
function calculateAgentRank()
{
    ...
    if (file_exists($cache_file)) {
        ...
        $deal_selects = ['BEGINDATE', 'ASSIGNED_BY_ID', 'UF_CRM_1591696067251'];
        $deal_orders = ['UF_CRM_1591696067251' => 'DESC', 'BEGINDATE' => 'DESC'];
        ...
        function store_agents($sorted_deals, &$global_ranking)
        {
            foreach ($sorted_deals as $deal) {
                ...
                if (true) { // Adjust condition if necessary
                    ...
                    $gross_comms = isset($deal['UF_CRM_1591696067251']) ? (int)explode('|', $deal['UF_CRM_1591696067251'])[0] : 0;
